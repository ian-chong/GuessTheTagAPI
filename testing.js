...
const randomWordGenerator = [ "wedding", "exercise", "railroad", "skydiving", "flags", "coin", "cars", "fish", "mountain", "knife", "eraser", "singapore"];
...
function getTaggedPhotos(tagName){
	fetch('https://api.tumblr.com/v2/tagged?tag= ' + rightAnswer + '&api_key=11DYWrO613GHck2XW709090wZe8ZzcJ4JSTiQ0nBTzWbTfHiCb')
